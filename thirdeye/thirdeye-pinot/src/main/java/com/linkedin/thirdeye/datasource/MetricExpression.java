...
public class MetricExpression {
  ...
  public boolean equals(Object o) {
    ...
    MetricExpression that = (MetricExpression) o;
    return Objects.equals(getExpressionName(), that.getExpressionName()) && Objects
        .equals(getExpression(), that.getExpression()) && aggFunction == that.aggFunction && Objects
        .equals(getDataset(), that.getDataset());
  }

  @Override
  public int hashCode() {
    return Objects.hash(getExpressionName(), getExpression(), aggFunction, getDataset());
  }
