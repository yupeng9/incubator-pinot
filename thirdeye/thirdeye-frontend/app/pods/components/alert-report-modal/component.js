...
export default Component.extend({
   ...
   */
  allApplicationNames: Ember.computed.reads('allAppNames'),
  //allApplicationNames: this.get('allAppNames'),


  /**
   * The list of all existing alert configuration groups.
   */
  allAlertsConfigGroups: Ember.computed.reads('allConfigGroups'),
  //allAlertsConfigGroups: this.get('allConfigGroups'),
