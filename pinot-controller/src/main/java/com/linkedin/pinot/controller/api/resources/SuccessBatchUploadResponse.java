...
public class SuccessBatchUploadResponse {
  private String _status;
  private String _batchId;
  private long _currentSizeAcrossReplicas;
  private long _storageQuotaAcrossReplicas;

  public SuccessBatchUploadResponse(String status, String batchId, long currentSizeAcrossReplicas, long storageQuotaAcrossReplicas) {
    _status = status;
    _batchId = batchId;
